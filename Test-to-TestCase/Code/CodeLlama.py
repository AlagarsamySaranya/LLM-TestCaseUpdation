...
model_name = "codellama/CodeLlama-7b-hf"  # You can replace this with a smaller model if needed
...
for _, row in df_train.iterrows():
    ...
    # Format input-output as prompt-completion pair (CodeLlama uses standard prompt format)
    train_data.append({
...
training_args = TrainingArguments(
    output_dir="./codellama_finetuned",
...
# Train model
print("Starting fine-tuning of CodeLlama...")
trainer.train()
print("Fine-tuning complete.")

# Save the fine-tuned model
trainer.save_model("./codellama_finetuned")
print("Model saved.")

# Load fine-tuned model for inference
fine_tuned_model = AutoModelForCausalLM.from_pretrained("./codellama_finetuned")
fine_tuned_model.to("cuda")

# Function to generate new test cases using CodeLlama
