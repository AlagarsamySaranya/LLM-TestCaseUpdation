...
# Load CodeGemma model and tokenizer
model_name = "google/codegemma-7b"  # Replace with the correct model version if needed
...
for _, row in df_train.iterrows():
    ...
    # Format input-output as prompt-completion pair (CodeGemma uses structured prompts)
    train_data.append({
...
training_args = TrainingArguments(
    output_dir="./codegemma_finetuned",
...
# Train model
print("Starting fine-tuning of CodeGemma...")
trainer.train()
print("Fine-tuning complete.")

# Save the fine-tuned model
trainer.save_model("./codegemma_finetuned")
print("Model saved.")

# Load fine-tuned model for inference
fine_tuned_model = AutoModelForCausalLM.from_pretrained("./codegemma_finetuned")
fine_tuned_model.to("cuda")

# Function to generate new test cases using CodeGemma
def generate_test_case(old_method, new_method, old_test_case):
    input_text = f"### Old Method:\n{old_method}\n\n### New Method:\n{new_method}\n\n### Old Test Case:\n{old_test_case}\n\n### Generate New Test Case:\n"
