...
# ✅ Fix: Load Phi model correctly with remote code enabled
...
# Train model
print("Starting fine-tuning of Phi...")
trainer.train()
print("Fine-tuning complete.")

# Save the fine-tuned model
trainer.save_model("./phi_finetuned")
print("Model saved.")

# Load fine-tuned model for inference
fine_tuned_model = AutoModelForCausalLM.from_pretrained("./phi_finetuned", trust_remote_code=True)
fine_tuned_model.to("cuda")

# Function to generate new test cases using Phi
