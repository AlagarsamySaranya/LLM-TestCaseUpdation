...
# Load XGen model and tokenizer
model_name = "Salesforce/xgen-7b-8k-inst"  # Replace with the correct model version if needed
...
for _, row in df_train.iterrows():
    ...
    # Format input-output as prompt-completion pair (XGen uses structured prompts)
    train_data.append({
...
# Train model
print("Starting fine-tuning of XGen...")
trainer.train()
print("Fine-tuning complete.")

# Save the fine-tuned model
trainer.save_model("./xgen_finetuned")
print("Model saved.")

# Load fine-tuned model for inference
fine_tuned_model = AutoModelForCausalLM.from_pretrained("./xgen_finetuned")
fine_tuned_model.to("cuda")

# Function to generate new test cases using XGen
